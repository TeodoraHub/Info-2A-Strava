        ...
        try:
            with DBConnection().connection as connection:
                with connection.cursor() as cursor:
                    # Vider la table activite et réinitialiser la séquence
                    print("🧹 Vidage de la table activite et réinitialisation de la séquence...")
                    cursor.execute("TRUNCATE TABLE activite RESTART IDENTITY;")
